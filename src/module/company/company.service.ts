...
export class CompanyService {
  ...
  async readCompany(input: ReadCompanyInput) {
    ...
    let whereClause : Prisma.pharmaceuticalcompanyWhereInput= {
      ...
      PharmaceuticalCompany_established_year : rawWhere.pharmaceuticalCompany_established_year
       

    };
    const count = this.prisma.pharmaceuticalcompany.count({ where: whereClause });
  ...
  async creatCompany(input : CreatCompanyInput){
    ...
    const company  = this.prisma.pharmaceuticalcompany.create({
      data:{
        ...
        PharmaceuticalCompany_established_year : data.pharmaceuticalCompany_established_year,
